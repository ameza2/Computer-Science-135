// Abraham Meza - complex_calculator_.c - CS 135 //
...
void divide(float real_part_1, float imaginary_part_1, float real_part_2, float imaginary_part_2, float *real_result, float *imaginary_result){
  float real_product, imaginary_product, real_imaginary1, real_imaginary2, real_product2, imaginary_product2;
  ...
  real_product2 = (real_part_2 * real_part_2);
  imaginary_product2 = (imaginary_part_2 * imaginary_part_2);

  *real_result = (real_product + (-1 * -1 * imaginary_product)) / (real_product2 + (-1 * -1 * imaginary_product2));
  *imaginary_result = ((-1 * real_imaginary1) + real_imaginary2) / (real_product2 + (-1 * -1 * imaginary_product2));
}
